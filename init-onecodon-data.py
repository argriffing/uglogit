...
#TODO this file looks familiar...
# It is copied from init-aa-data.py.
...
def main():
    ...
    with open(filename_prefix + '.predict', 'wb') as fout_predict:
        fmt = 'd' * len(exog[0])
    ...
    with open(filename_prefix + '.respond', 'wb') as fout_respond:
        fmt = 'i'
